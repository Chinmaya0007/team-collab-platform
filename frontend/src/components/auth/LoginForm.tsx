  ...
  return (
    <>
      ...
      >
        ...
        <button
          type="submit"
          className="flex h-[48px] w-full items-center justify-center gap-[8px] rounded-[12px] bg-[#3525cd] text-[16px] font-semibold text-white transition hover:bg-[#2f20b8] active:scale-[0.98]"
        >
          Sign In
